...
export class AuthService {
    ...
    signUp( email: string, password: string ) {
        return this.http.post<AuthResponseData>
            ( 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDe7IMuASoRlfAX32m-Yh6XVZhTryNRolY',
                {
                    email: email,
                    password: password,
    ...
    login( email: string, password: string ) {
        ...
        return this.http.post<AuthResponseData>
            ( 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDe7IMuASoRlfAX32m-Yh6XVZhTryNRolY',
                {
                    email: email,
                    password: password,
                    returnSecureToken: true
